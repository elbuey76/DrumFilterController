...
| S-004 | Le système devrait détecter un niveau bas d'eau. | Should | Protection de pompe selon configuration hydraulique. |
| S-005 | Le système devrait détecter l'absence de rotation du tambour. | Could | Nécessite un capteur supplémentaire. |
