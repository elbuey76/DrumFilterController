...
L'alimentation du coffret FAT doit venir d'un depart dedie cote maison, protege par un disjoncteur 16 A. Ce calibre remplace l'hypothese initiale de 20 A. La liaison existante vers le local filtration fait environ 20 m et sa section est confirmee en 3G2,5 mm2 ; le cable est actuellement en attente sans disjoncteur au tableau maison. Le choix de conserver 16 A limite volontairement le courant total disponible et cette protection doit etre installee avant le raccordement du coffret.
...
| Pompe de rincage | Disjoncteur 6 A courbe C | Pompe de rincage 230 VAC | Commandee par contacteur moteur Schneider TeSys LC1D18P7, bobine 230 VAC. Son courant nominal connu est 3,5 A ; le 6 A C remplace le 10 A pour une protection plus ajustee, sans que le passage au 18 A AC-3 ne modifie le calibre de protection du depart. |
...
La pompe de rincage est commandee par un relais de l'automate qui pilote directement la bobine 230 VAC d'un contacteur moteur Schneider Electric TeSys LC1D18P7, 3P, 18 A, AC-3. Cette reference remplace le LC1D12P7 car elle est disponible au meme prix, conserve la bobine 230 VAC `P7` et ajoute une marge moteur superieure ; le depart est protege par disjoncteur 6 A courbe C, ajuste au courant nominal pompe connu de 3,5 A. Cette solution est retenue pour eviter d'ajouter un relais intermediaire 12 V -> 230 V et parce que le contacteur equivalent en bobine 12 VDC avec categorie moteur AC-3 est difficile a sourcer ; le schema final devra donc traiter clairement le cheminement 230 VAC de cette commande, la separation BT/secteur et le reperage des borniers.
...
- Le depart cote maison doit etre protege par un disjoncteur 16 A dedie, cote maison. La liaison existante d'environ 20 m est confirmee en 3G2,5 mm2, mais le cable est en attente : le disjoncteur doit etre achete et installe. Ce calibre limite volontairement le courant total disponible du coffret filtration.
