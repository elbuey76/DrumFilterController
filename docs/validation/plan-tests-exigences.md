...
| B-107 | Must | Test sur banc + Inspection | Interface KC868-A16 / CR18-8DN | Les capteurs CR18-8DN alimentés en 12 VDC sont lus correctement sur les entrées digitales KC868-A16 en repos et détection ; le câblage marron +12 VDC, bleu 0 V commun, noir `Ix` est conforme ; le courant d'entree et les cas fil noir, bleu ou marron débranché sont observés et documentés avec le sens logique firmware retenu. | À définir |
